...
# === Tools ===
PROCYON_JAR="$SCRIPT_DIR/tools/procyon-compilertools.jar"
...
[ -f "$PROCYON_JAR" ] || error_exit "Procyon Compilertools not found: $PROCYON_JAR"
...
# === Decompile ===
info "Decompiling mapped jar (via Procyon)..."
mkdir -p sources
java -jar "$PROCYON_JAR" build/server-mapped.jar -o sources
